...
@Suite
@SelectClasses({
        Test01SuccessWhenInitializeAgentOrServer.class,
        Test02SuccessWhenInitializeDevice.class,
        Test03SuccessWhenTransferDeviceOwnership.class,
        Test04SuccessWhenAccessDeviceByOwner.class,
        Test05SuccessWhenAccessDeviceByOthers.class,
        Test06SuccessWhenAccessDeviceByPrivateSession.class,
        Test11FailWhenInitializeAgentOrServer.class,
        Test12FailWhenInitializeDevice.class,
        Test13FailWhenTransferDeviceOwnership.class,
        Test14FailWhenAccessDeviceByOwner.class,
        Test15FailWhenAccessDeviceByOthers.class,
        Test16FailWhenAccessDeviceByPrivateSession.class,
})
